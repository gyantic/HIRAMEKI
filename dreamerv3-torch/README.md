...
```
Run training on Maniskill:
```
python3 dreamer.py --configs maniskill --task maniskill_PickCube-v1 --logdir ./logdir/maniskill_pickcube
```
Monitor results:
```
tensorboard --logdir ./logdir
```
To set up Atari, Minecraft, or Maniskill environments, please check the scripts located in [env/setup_scripts](https://github.com/NM512/dreamerv3-torch/tree/main/envs/setup_scripts).
...
| [Maniskill2](https://github.com/haosulab/ManiSkill2) | Image + State |Continuous |1M| Robot manipulation tasks with realistic physics simulation.|
